...
export default function HowWeWorkContainer() {
  ...
  return (
    <section id="howWeWork" className="relative w-full py-24 overflow-hidden" aria-label="Metodologia realizacji projektów IT">
      {/* Enhanced Background */}
      ...
      >
        ...
        <motion.p className="text-xl md:text-2xl text-white/80 text-center mb-20 max-w-3xl mx-auto" variants={subtitleVariants} itemProp="description">
          {t("subtitle")}
        </motion.p>
