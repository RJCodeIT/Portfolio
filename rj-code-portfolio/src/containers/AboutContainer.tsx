...
function AboutContainerComponent() {
  ...
  const whyWorkWithUsItems = useMemo(
    () => ["experiencedTeam", "modernTools", "customerCentric", "endToEnd"],
    []
  );
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-6 relative space-y-20">
        ...
        >
          <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-8 text-white bg-clip-text text-transparent bg-gradient-to-r from-primary via-secondary to-accent animate-gradient bg-[length:200%_auto] break-words">
            {t("whoWeAre")}
          </h2>
            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-10 mt-10">
                {technologies.map((tech, idx) => (
                  <Tooltip
                    key={tech.key}
                    content={t(`technologies.${tech.key}.description`)}
                  >
                    <motion.div
        ...
        >
          <p className="text-xl mb-8 text-gray-400">{t("callToAction")}</p>
          <Button
            size="lg"
...
export default memo(AboutContainerComponent);
